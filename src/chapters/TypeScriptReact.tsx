...
function BuggyUserCard() {
  return (
    <div style={{ padding: '0.5rem', background: 'var(--color-bg-secondary)', borderRadius: 0 }}>
      ...
      <p style={{ fontSize: '0.75rem', color: '#ef4444', marginTop: '0.4rem' }}>No autocomplete, no type safety</p>
    </div>
  );
}
...
function FixedUserCard() {
  ...
  return (
    <div style={{ padding: '0.5rem', background: 'var(--color-bg-secondary)', borderRadius: 0 }}>
      ...
      <p style={{ fontSize: '0.75rem', color: 'var(--color-success)', marginTop: '0.4rem' }}>Full autocomplete and type safety</p>
    </div>
  );
}
